...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 z-[100] h-[72px] flex items-center justify-between px-4 md:px-[5%] transition-all duration-500
        ${!isTransparent
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {mounted && user ? (
            <div className="relative hidden sm:block" ref={dropdownRef}>
              ...
              {dropdownOpen && (
                <div className="absolute right-0 top-12 w-48 bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden z-[200]">
      ...
      {menuOpen && (
        <div className="fixed top-[72px] left-0 right-0 z-[99] bg-white dark:bg-gray-900 shadow-lg md:hidden border-t border-gray-100 dark:border-gray-800">
